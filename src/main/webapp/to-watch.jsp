...
<link href="css/to-watch.css" rel="stylesheet" type="text/css">
    ...
    <table>
        ...
        <c:forEach items="${movies}" var="m">
            <tr>
                ...
                <td name="remove">
                    <form action="/addToWatched" method="post">
                        <input type="hidden" name="id" value="${m.getId()}">
                        <input type="submit" name="add" value="Add to watched">
                    </form>
                </td>
            </tr>
        </c:forEach>
    </table>
    <form action="/randomMovie" method="post">
        <input type="submit" name="random" value="Pick a random movie">
        <c:forEach items="${movie}" var="m">
            <label>${m.getTitle()} - ${m.getDirector()}</label>
        </c:forEach>
    </form>
